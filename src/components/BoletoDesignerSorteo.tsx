...
const BoletoDesignerSorteo: React.FC<BoletoDesignerPuroProps> = ({
  onSave,
  width = 500,
  height = 333.5,
  loading = false,
  ...
  const [textInputs, setTextInputs] = useState([
    { id: 1, text: 'Fecha', fontFamily: 'Permanent Marker', fontSize: 24, color: '#000000', isActive: false },
    { id: 2, text: 'Rifa', fontFamily: 'Permanent Marker', fontSize: 32, color: '#000000', isActive: false },
    { id: 3, text: 'Numeros', fontFamily: 'Permanent Marker', fontSize: 48, color: '#000000', isActive: false },
  ]);
...
export default BoletoDesignerSorteo;
